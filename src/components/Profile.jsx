      ...
      <div className="profile-card">
        ...
        {!isEditing ? (
          ...
          <>
            ...
            <label>
              Biography: 
              <input type="text" name="biography" value={profile.biography} onChange={handleChange} />
            </label>
            <label>
              Country: 
            ...
            <label>
              ...
              <input type="text" value={profile.interests.join(", ")} onChange={handleInterestsChange} />
            </label>
